...
{
    public class AircraftCarrier: WaterVehicle
    {
        private readonly IVehicle _vehicle;

        public AircraftCarrier(int displacement, int enginePower, IVehicle.VehicleFuelType fuelType) : base(displacement, true, enginePower, fuelType)
        {
            _vehicle = this;
        }
